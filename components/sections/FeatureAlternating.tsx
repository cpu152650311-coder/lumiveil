              ...
              <div key={i} className={`flex flex-col ${isLeft ? 'lg:flex-row' : 'lg:flex-row-reverse'} items-center gap-10 lg:gap-16`}>
                <div className="lg:w-1/2">
                  {feat.image ? (
                    ...
                    <div className="w-full max-w-lg mx-auto h-64 bg-accent-light rounded-card flex items-center justify-center">
                ...
                <div className="lg:w-1/2 max-w-lg">
                  ...
                  {feat.link && (
                    <Link href={feat.link.href} className="inline-flex items-center gap-1 text-accent font-semibold mt-3 hover:opacity-80 transition-opacity">
