...
const faqItems = [
  ...
  { question: 'Is my health data stored securely?', answer: 'Yes. All health data is encrypted at rest (AES-256) and in transit (TLS 1.3). HealthCore AI processing runs entirely on-device — raw biometric data never leaves your watch. Lumivex is GDPR compliant with enterprise-grade encryption.' },
